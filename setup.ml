...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7ec278b59debcac664faefc04f5c4945) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/hardcaml-meta";
          synopsis = "RTL metadata";
          description = Some [OASISText.Para "VHDL/Verilog core metadata"];
          categories = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("atdgen", None)];
                   ...
                   {
                      lib_modules = ["Cores_j"; "Cores_t"; "Cores"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "hardcaml-meta";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build ini file conversion tools";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "converter", true)
                        ];
                   ...
                   {exec_custom = true; exec_main_is = "ini2core.ml"});
               Executable
                 ({
                     cs_name = "hardcamlfind";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "hardcamlfind.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/hardcaml-meta";
                      src_repo_browser =
                        Some "https://github.com/ujamjar/hardcaml-meta";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\203\184\024\223\151\016\242[\128\025\203o\003E^N";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
